...
import static com.gersimuca.customer_management_application.enumaration.Permission.*;
import static com.gersimuca.customer_management_application.enumaration.Role.*;
...
//                                .requestMatchers(GET, "**/api/v1/management/**").hasAnyAuthority(EMPLOYEE_READ.name())
//                                .requestMatchers(POST, "**/api/v1/management/**").hasAnyAuthority(EMPLOYEE_CREATE.name())
//                                .requestMatchers(PUT, "**/api/v1/management/**").hasAnyAuthority(EMPLOYEE_UPDATE.name())
//                                .requestMatchers(DELETE, "**/api/v1/management/**").hasAnyAuthority(EMPLOYEE_DELETE.name())
//
